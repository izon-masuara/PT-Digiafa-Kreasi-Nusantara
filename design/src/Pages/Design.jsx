                            ...
                            <div className="w-full h-40 bg-white mt-10 p-2">
                                ...
                                <div className="pt-4 flex justify-center">
                                    <div className="grid grid-cols-3 gap-3">
                                        ...
                                        <div className="flex">
                                            <p>F &nbsp;</p>
                                            <input type="number" min={5} className="border-2 border-black w-10 h-6" onChange={(e) => setFontSize(e.target.value)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="pt-4 w-full flex justify-center">
                                    <button onClick={() => setBoxtText({ text: text, width: width, height: height, fontSize: fontSize })} className="border-black border-2 p-1 rounded-md px-4 hover:bg-orange-500 hover:font-semibold bg-orange-200">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
